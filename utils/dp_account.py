...
def reverse_eps(eps, num_iter, delta, num_nodes= None, clip= None, topology_name= None, degree_matrix= None, adjacency_matrix= None, subsample=1., batch_size=1., multiple = True):
    ...
    if math.isclose(subsample, 1.):
        ...
        result = param_search.binary_search_eps(eps, num_iter, delta, num_nodes, clip, topology_name, degree_matrix, adjacency_matrix, subsample, batch_size, multiple)
